...
namespace coursework_forms {
    partial class leave_view {
        ...
        private void InitializeComponent() {
            ...
            this.leaveTableAdapter = new coursework_forms.CourseworkDataSetTableAdapters.LeaveTableAdapter();
            ...
            this.dgv_sotr.DataSource = this.leaveBindingSource;
            ...
            this.iDДDataGridViewTextBoxColumn.ReadOnly = true;
            ...
            this.leaveBindingSource.DataSource = this.courseworkDataSet;
            // 
            // courseworkDataSet
            // 
            ...
            this.rtb_reason.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.leaveBindingSource, "Причина", true));
        ...
        private CourseworkDataSetTableAdapters.LeaveTableAdapter leaveTableAdapter;
