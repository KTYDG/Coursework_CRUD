...
namespace coursework_forms {
    public partial class rest_view: Form {
        ...
        private void sotr_view_Load(object sender, EventArgs e) {
            // TODO: This line of code loads data into the 'courseworkDataSet.Rest' table. You can move, or remove it, as needed.
            this.restTableAdapter.Fill(this.courseworkDataSet.Rest);
        ...
        private void b_options_Click(object sender, EventArgs e) {
            ...
            openChildForm(new common_options(this.restBindingSource, "[Дата начало]"), p_filter_options);
        }
        ...
        private void b_update_Click(object sender, EventArgs e) {
            ...
            foreach(DataGridViewRow row in dgv_sotr.Rows) {
                ...
                SqlCommand comm = new SqlCommand("UPDATE Rest SET Описание = '" + reason + "', [Дата конец] = '" + Date_end + "' WHERE ID_Д = " + ID, connection);
                try {
        ...
        private void b_delete_Click(object sender, EventArgs e) {
            foreach(DataGridViewRow item in this.dgv_sotr.SelectedRows) {
                ...
                // создание подключения SqlConnection
                SqlConnection connection = new SqlConnection(connString);
                SqlCommand comm = new SqlCommand("DELETE FROM Отпуск WHERE id_отпуск = " + id, connection);
